...
content = re.sub(r'/\* Upload \*/.*?\.side\.collapsed \.drop-text, \.side\.collapsed \.drop-file \{ display: none; \}', css_drop_new, content, flags=re.DOTALL)

with open("templates/dashboard.html", "w") as f:
    f.write(content)

print("Dropzone CSS patch applied.")
